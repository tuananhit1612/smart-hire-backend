...
public class DatabaseSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        String[] benefitsTpl = {
            ...
            "<ul><li>Thời gian làm việc linh hoạt (Flexible Working Hours/Hybrid).</li><li>Môi trường quốc tế, chuyên nghiệp và cực kỳ cởi mở.</li><li>Hoạt động văn hoá phong phú (teambuilding, dã ngoại 2-3 lần/năm).</li><li>Tháng lương thứ 14 và review lương 2 lần/năm.</li><li>Chính sách mua cổ phiếu ESOP ưu đãi.</li></ul>"
        };
